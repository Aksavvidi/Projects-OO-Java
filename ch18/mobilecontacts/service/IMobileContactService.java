...
public interface IMobileContactService {
     ...
     *      the DTO object that contains the mobile data.
     * @return
     *      the resulting {@link MobileContact}
     * @throws PhoneNumberAlreadyExistsException
     *       if the {@link MobileContact#phoneNumber} already exists
     *       in the datasource.
     * @throws UserIdAlreadyExistsException
     *       if the {@link MobileContact#id} already exists
     *      *       in the datasource.
     */
     ...
     * @throws PhoneNumberAlreadyExistsException
     *       if the new {@link MobileContact#phoneNumber} already exists
     *       in the datasource.
     * @throws ContactNotFoundException
     *       if {@link MobileContactDTO#mobileContactId} does not map
     ...
     * @throws ContactNotFoundException
     *          if {@link MobileContactDTO#phoneNumber} does not map
     *           to a {@link MobileContact} in the datasource.
     */
    ...
    /**
     * Returns all the {@link MobileContact} instances of th datasource.
     *
     * @return
